# Multi-Category News Spec

## Purpose

Defines how the system fetches news from multiple NHK RSS feed categories in parallel and structures the output data with explicit main news and per-category sections.
