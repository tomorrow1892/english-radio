...
Defines the white-based light color scheme for the application, replacing the previous dark theme with a pop, bright aesthetic using vibrant accent colors and ensuring readable article title layouts.
